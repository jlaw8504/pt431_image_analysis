function varargout = population_GUI_v1_2_mac(varargin)
% POPULATION_GUI_V1_2_MAC MATLAB code for population_GUI_v1_2_mac.fig
%      POPULATION_GUI_V1_2_MAC, by itself, creates a new POPULATION_GUI_V1_2_MAC or raises the existing
%      singleton*.
%
%      H = POPULATION_GUI_V1_2_MAC returns the handle to a new POPULATION_GUI_V1_2_MAC or the handle to
%      the existing singleton*.
%
%      POPULATION_GUI_V1_2_MAC('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in POPULATION_GUI_V1_2_MAC.M with the given input arguments.
%
%      POPULATION_GUI_V1_2_MAC('Property','Value',...) creates a new POPULATION_GUI_V1_2_MAC or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before population_GUI_v1_2_mac_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to population_GUI_v1_2_mac_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help population_GUI_v1_2_mac

% Last Modified by GUIDE v2.5 28-Apr-2016 11:02:10

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @population_GUI_v1_2_mac_OpeningFcn, ...
    'gui_OutputFcn',  @population_GUI_v1_2_mac_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before population_GUI_v1_2_mac is made visible.
function population_GUI_v1_2_mac_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to population_GUI_v1_2_mac (see VARARGIN)

% Choose default command line output for population_GUI_v1_2_mac
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes population_GUI_v1_2_mac wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = population_GUI_v1_2_mac_OutputFcn(hObject, eventdata, handles)
